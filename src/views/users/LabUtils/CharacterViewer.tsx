...
import { Camera, Upload, Download, RotateCcw, Lightbulb, Gpu, Box, Accessibility, Smile, LogOut, RotateCw, Menu, X } from "lucide-react";
  ...
  return (
    <div className="relative w-full flex overflow-hidden text-white font-sans" style={{ backgroundColor: '#020202' }}>
      ...
      <main className="flex-1 relative flex flex-col min-h-[calc(100dvh-12rem)]" style={{ backgroundColor: '#020202' }}>
        ...
        <div className="absolute top-8 left-16 md:left-10 z-10 flex items-center gap-3">
